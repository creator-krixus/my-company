...
<ul>
    ...
    FORMULARIO DE CONTACTO.
        <ul>
            <li>
                Finalidades: Facilitarle un medio para que pueda ponerse en contacto con nosotros y contestar a sus solicitudes de información brindándole una asesoría personalizada.
            </li>
            <li>
                Legitimación: Su consentimiento al solicitarnos información a través de nuestro formulario de contacto.
            </li>
            <li>
                Conservación: Una vez resuelta su solicitud por medio de nuestro formulario o contestada por correo electrónico, si no ha generado un nuevo tratamiento.
            </li>
        </ul>
    </li>
    <li>
        ...
        <ul>
          <li>
            Finalidades: Enviarle nuestro boletín comercial, así como comunicaciones informativas y publicitarias sobre nuestros productos o servicios que sean de su interés, incluso por medios electrónicos (Correo electrónico, SMS, WhatsApp), si acepta o se suscribe a nuestro boletín.
          </li>
          <li>
            Legitimación: Su consentimiento al suscribirse a nuestros envíos comerciales y/o newsletters.
          </li>
          <li>
            Conservación: Hasta que el interesado revoque el consentimiento y solicite la desuscripción del servicio.
          </li>
        </ul>
    </li>
    <li>
        ...
        <ul>
          <li>
            Finalidades: Contestar a sus solicitudes de información, atender a sus peticiones y responder sus consultas o dudas. En caso de recibir su hoja de vida, sus datos personales y curriculares podrán formar parte de nuestras bases de datos para participar en nuestros procesos de selección presentes y futuros.
...
<p>
    ...
    <ul>
        ...
        <li>
            Terceros que nos ayudan a proporcionar servicios digitales, como administración de identidades, CRM, análisis web y motor de búsqueda.
        </li>
        <li>
